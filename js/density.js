...
class Slider {
	...
	initVis(){
		...
		document.getElementById('count').innerText = "# of tweets in time block: " + tmpData.length
		document.getElementById('info').innerText = "# of tweets per minute (as shown by the bar below): " + tmpData.length/2
	...
	updateVis(){
		...
		document.getElementById('count').innerText = "# of tweets in " + vis.minutes + " minute time block: " + vis.filteredData.length
		document.getElementById('info').innerText = "# of tweets per minute (as shown by the bar below): " + Math.round(vis.filteredData.length/vis.minutes)
	}
